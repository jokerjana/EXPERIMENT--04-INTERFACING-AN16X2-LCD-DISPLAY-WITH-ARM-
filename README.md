...
int main(void)
{
  ...
  Lcd_PortType ports[] = { GPIOA, GPIOA, GPIOA, GPIOA };
     ...
     Lcd_cursor(&lcd, 0,1);
     Lcd_string(&lcd, "JANARTHANAN B");
     Lcd_cursor(&lcd, 1,1);
     Lcd_string(&lcd, "212223100014");
  /* USER CODE END 2 */
...
![Screenshot 2025-04-28 212736](https://github.com/user-attachments/assets/e88f74e1-f4e5-4f91-a0c4-dde28cc4e5f9)


 
 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
![Screenshot 2025-04-28 214445](https://github.com/user-attachments/assets/4c52edb7-d8a6-4481-a73e-fe35cc0b98ef)
